...
//        if (r.sign == true)
//        	fprintf(f, "%s reg number %d read: %d default: %d\n", ptr, i, (int)read_value, (int)r.dflt);
//        else
//            fprintf(f, "%s reg number %d read: %u default: %u\n", ptr, i, (unsigned int)read_value, (unsigned int)r.dflt);
//    }
