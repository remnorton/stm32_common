...
static uint32_t lora_sync_word1 = 0x00;
static uint32_t lora_sync_word2 = 0x00;
...
void lgw_constant_adjust(void) {
    ...
    lgw_reg_w(LGW_FRAME_SYNCH_PEAK1_POS, lora_sync_word1);
    lgw_reg_w(LGW_FRAME_SYNCH_PEAK2_POS, lora_sync_word2);
    ...
    lgw_reg_w(LGW_MBWSSF_FRAME_SYNCH_PEAK1_POS, lora_sync_word1);
    lgw_reg_w(LGW_MBWSSF_FRAME_SYNCH_PEAK2_POS, lora_sync_word2);
    ...
    lgw_reg_w(LGW_TX_FRAME_SYNCH_PEAK1_POS, lora_sync_word1);
    lgw_reg_w(LGW_TX_FRAME_SYNCH_PEAK2_POS, lora_sync_word2);
...
int lgw_board_setconf(struct lgw_conf_board_s conf) {
    ...
    lora_sync_word2 = conf.syncword & 0x0f;
    lora_sync_word1 = (conf.syncword & 0xf0) >> 4;
    rf_clkout = conf.clksrc;

    DEBUG_PRINTF("Note: board configuration; lora_sync_word:%d %d, clksrc:%d\n", lora_sync_word1, lora_sync_word2, rf_clkout);
